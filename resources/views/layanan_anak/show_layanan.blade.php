            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row-fluid">
                        ...
                        Total layanan yang harus diterima <h5><span class="badge bg-secondary" style="display:inline;">{{ $manfaat ? $manfaat->task_ava : 'N/A'}} </span></h5>  
                        Total layanan yang diterima<h5><span class="badge bg-secondary" style="display:inline;">{{ $manfaat ? $manfaat->task_val : 'N/A' }}  </span></h5>  
                        ...
                        <table class="table table-bordered mt-1 table-hover table-striped table-sm">
                            ...
                            <tr>
                                ...
                                <td><small>{{ \Carbon\Carbon::parse($data->start)->format('d-m-Y') }}</small></td>
                                <td><small>{{ \Carbon\Carbon::parse($data->end)->format('d-m-Y') }}</small></td>
