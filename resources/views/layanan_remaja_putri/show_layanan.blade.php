            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row-fluid">
                        ...
                        Total layanan yang harus diterima <h5 style="display:inline;"><span class="badge bg-secondary">{{ $manfaat ? $manfaat->task_ava : 'N/A'}} </span></h5>  
                        Total layanan yang diterima <h5 style="display:inline;"><span class="badge bg-secondary">{{ $manfaat ? $manfaat->task_val : 'N/A' }}  </span></h5>  
