            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row-fluid">
                        ...
                        <!-- Form Pencarian -->
                        <form action="{{ route('mastersasaran.inputbykpm') }}" method="GET" class="mb-4">
                        ...
                        <table class="table table-bordered mt-1 table-hover table-striped table-sm">
                         ...
                         <div class="pagination">
                                ...
                                @if($sasaran->previousPageUrl())
                                    <a href="{{ $sasaran->previousPageUrl() }}{{ strpos($sasaran->previousPageUrl(), '?') !== false ? '&' : '?' }}query={{ request('query') }}" class="btn btn-primary">Previous</a>
                                @endif

                                @if($sasaran->nextPageUrl())
                                    <a href="{{ $sasaran->nextPageUrl() }}{{ strpos($sasaran->nextPageUrl(), '?') !== false ? '&' : '?' }}query={{ request('query') }}" class="btn btn-primary">Next</a>
                                @endif
