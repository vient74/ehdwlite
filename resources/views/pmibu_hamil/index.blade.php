        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row-fluid">
                        <h2>Penerima Manfaat Ibu Hamil Nifas</h2>
                        Jumlah penerima manfaat yang telah diinput {{ $formattedAngka = number_format($jumlahPm, 0, ',', '.') }} data  
                        <!-- Form Pencarian -->
                        <form action="{{ route('pmibu_hamil.index') }}" method="GET" class="mb-4">
                        ...
                        <table class="table table-bordered mt-1 table-hover table-striped table-sm">
                         ...
                         <div class="pagination">
                                @if($hamils->previousPageUrl())
                                    <a href="{{ $hamils->previousPageUrl() }}" class="btn btn-primary">Previous</a>
                                @endif

                                @if($hamils->nextPageUrl())
                                    <a href="{{ $hamils->nextPageUrl() }}" class="btn btn-primary">Next</a>
                                @endif
                            </div>
                            <br> 

                        <a href="{{ route('pmibu_hamil.index') }}" class="btn btn-md btn-warning">back</a>
