        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row-fluid">
                        <h2>Penerima Manfaat Remaja Putri</h2>
                        ...
                        <table class="table table-bordered mt-1 table-hover table-striped table-sm">
                            ...
                            @forelse ($remajas as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('layanan_remaja_putri.show_layanan', $data->nik) }}">
                                            <span class="badge bg-secondary">Lihat Layanan Diterima</span>
                                        </a>
                         ...
                         <div class="pagination">
                                @if($remajas->previousPageUrl())
                                    <a href="{{ $remajas->previousPageUrl() }}" class="btn btn-primary">Previous</a>
                                @endif

                                @if($remajas->nextPageUrl())
                                    <a href="{{ $remajas->nextPageUrl() }}" class="btn btn-primary">Next</a>
                                @endif
                            </div>
                            <br> 
